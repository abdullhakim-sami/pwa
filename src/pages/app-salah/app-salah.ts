...
import { styles } from './salah-styles';

import { styles as sharedStyles } from '../../styles/shared-styles'

import '@shoelace-style/shoelace/dist/components/card/card.js';

@customElement('app-salah')
export class Appsalah extends LitElement {
  static styles = [
    sharedStyles,
    styles
  ]
      ...
      <main>
        ...
        <sl-card>
          ...
          <p>Check out <a
              ...
              docs</a> to learn more salah the advanced features that you can use in your PWA</p>
        </sl-card>
      </main>
    `;
  }
